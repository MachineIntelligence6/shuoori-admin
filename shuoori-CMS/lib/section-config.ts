...
export const SECTION_CONFIGS: SectionConfig[] = [
  ...
  },
  {
    key: "hero",
    label: "Hero",
    description: "Main headline, intro copy, hero CTAs, badges, stats, and app-store assets.",
  ...
  },
  {
    key: "pricing",
    label: "Pricing",
    description: "Pricing plans, features, monthly/yearly prices, and CTA button.",
    itemLabel: "Pricing Plan",
    fields: [
      { name: "name", label: "Plan Name", type: "localized" },
      ...
      { name: "ctaLabel", label: "CTA Label", type: "localized" },
    ],
    defaultItem: {
      name: localized(),
      monthlyPrice: "$0.00/mth",
      yearlyPrice: "$0.00/year",
